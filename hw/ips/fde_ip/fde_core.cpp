...
#pragma HLS INLINE
    i_imm_t enc_i_imm_val = 0;
    enc_i_imm_val |= (i_imm_t)(dec_imm.instr_31 << 11);
...
#pragma HLS INLINE
    s_imm_t enc_s_imm_val = 0;
    enc_s_imm_val |= (s_imm_t)(dec_imm.instr_31 << 11);
...
#pragma HLS INLINE
    b_imm_t enc_b_imm_val = 0;
    enc_b_imm_val |= (b_imm_t)(dec_imm.instr_31 << 11);
...
#pragma HLS INLINE
    u_imm_t enc_u_imm_val = 0;
    enc_u_imm_val |= (u_imm_t)(dec_imm.instr_31 << 19);
...
#pragma HLS INLINE
    j_imm_t enc_j_imm_val = 0;
    enc_j_imm_val |= (j_imm_t)(dec_imm.instr_31 << 19);
